	...
	<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
		...
		>
			<div class="flex items-center justify-between">
				...
				<button
					...
					class="inline-flex items-center justify-center rounded-md bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
				>
					<svg
		...
		{:else if cases.length === 0}
			...
			>
				...
				<h3 class="mt-4 text-lg font-medium text-gray-900">No cases yet</h3>
		...
		{:else}
			<div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
				{#each cases as caseItem, i}
					<div
						class="group relative overflow-hidden rounded-lg border border-gray-200 bg-white p-6 shadow-sm transition-all hover:border-indigo-300 hover:shadow-md"
