...
<div class="min-h-screen bg-gray-50" in:fade={{ duration: 300, easing: cubicOut }}>
				...
				<nav class="mt-3 sm:mt-0" in:fly={{ y: -10, duration: 500, delay: 300, easing: cubicOut }}>
					{#if session}
						<ul class="flex space-x-6 text-white">
							...
							<li><a href="/cases" class="transition hover:text-indigo-200">Cases</a></li>
							<li><a href="/account" class="transition hover:text-indigo-200">Account</a></li>
							<li><a href="/help" class="rounded bg-white p-2 font-bold text-indigo-600 transition hover:bg-indigo-800 hover:text-white">Help</a></li>
						</ul>
					{:else}
						<a href="/auth/login" class="rounded bg-white p-2 font-bold text-indigo-600 transition hover:bg-indigo-800 hover:text-white">
							Sign In
						</a>
					{/if}
				</nav>
	...
	<footer class="mt-12 border-t bg-gray-100" in:fly={{ y: 20, duration: 600, delay: 500, easing: cubicOut }}>
		<div class="container mx-auto px-4 py-6 text-left text-sm text-gray-600" in:fade={{ duration: 500, delay: 600 }}>
